...
export async function buildPlugin(metaUrl, overrides = {}) {
    ...
    // 默认同步到本仓库 public/plugins(vendor/canvas-plugins/<name> → 上溯三层到仓库根)
    const publicDir = overrides.publicDir ?? join(root, "..", "..", "..", "public", "plugins");
    ...
    const syncToPublic = {
        ...
        setup(builder) {
            builder.onEnd(async (result) => {
                ...
                console.log(`[${name}] synced → public/plugins/${name}.js`);
            });
        },
    };
