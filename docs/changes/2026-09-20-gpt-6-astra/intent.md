...
- Source of truth：2026-09-20 复核的本地 main@80544af、该主线 AGENTS/governance/PROGRESS 与官方 OpenAI 文档。原 dirty checkout 初稿仅为历史来源；详见 spec.md 与 branch-rules-audit.md。
