...
- Verification: PARTIAL — 安全补审后本地 367 Node、299 项完整 browser 加 2 项定向 plugin browser、78 Rust、Agent 126 通过/2 跳过、UI159/0、功能29/0、治理59/0、类型/格式/Web build 均通过；Git 远端、Hosted CI、PR、安装包待回读。各历史变更包保留其原始验证时点。
