...
- REL-2.1.0 / EXT-GIT：2.1.0 源码经 [PR #9](https://github.com/soudbs180-creator/KK-Studio-2.0/pull/9) 合入 `main`；PR 当前 head 的 hosted `verify`/`delivery` 和合并后 `main` 的 verify 已通过。三套远端 ruleset 已 active，`main` 有效规则含 PR/必需检查/禁删除与非快进；正式 tag、安装包和发布验收仍未完成。
