...
当前共 **30** 个功能：REAL（真实可用）2、PARTIAL（部分可用）21、PROTOTYPE（仅演示/UI）5、PLANNED（仅计划）2。
...
| FEAT-030 | 多供应商接入与多目标配置 | PARTIAL（部分可用） | [卡片](feat-030-provider-connectivity.md) | TASK-PROV-002, TASK-PROV-003, TASK-PROV-004 |
