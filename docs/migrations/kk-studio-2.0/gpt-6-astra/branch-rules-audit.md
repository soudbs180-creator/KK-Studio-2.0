...
| 位置                                         | 分支/提交                                          | 用途与处理                                                        |
| -------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------- |
| <local-checkout>                             | codex/desktop-data-stability@609f524               | 原有大量 dirty 的保留现场；不切分支、不 stage/reset/clean/stash   |
| <integration-worktree>                       | main@80544af                                       | 当前稳定集成主线，审计时干净；不直接开发或推送                    |
